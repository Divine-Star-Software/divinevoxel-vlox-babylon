...
const smokeTexture = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAT0lEQVQ4jWNgGAW0BzU1Nf/J1kiMZkZSbG1pacFQz0SKq7KzszEMxmrA+/fvGd6/fw9nI9PoAKsXcNk2depU4ryArBmmCZtmvACbC4YpAAABtiTWb256SQAAAABJRU5ErkJggg==";
const flameTexture = "data:image/png;base64,";
export class CandleParticles extends VoxelEffect {
    ...
    init() {
        ...
        const meshPositoin = this.mesh.getPosition();
        {
            ...
            const texture = new Texture(flameTexture, scene, undefined, false, Texture.NEAREST_NEAREST_MIPNEAREST);
            ...
            particles.startPositionFunction = (worldMatrix, positionToUpdate) => {
                const randomEmitter = Math.floor(Math.random() * (this.points.length / 3)) * 3;
        ...
        }
        {
            ...
            // Set the particle texture
            const texture = new Texture(smokeTexture, scene, undefined, false, Texture.NEAREST_NEAREST_MIPNEAREST);
            particles.particleTexture = texture;
