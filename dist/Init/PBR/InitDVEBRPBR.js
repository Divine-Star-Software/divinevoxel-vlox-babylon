...
export default function InitDVEPBR(initData) {
   ...
   */
    ...
    ssr.environmentTexture = probe.cubeTexture;
    ssr.samples = 4;
    ssr.strength = 1;
    ...
    const renderer = CreateDefaultRenderer({
        ...
        afterCreate: async () => {
            ...
            // probe.renderList = [];
            const sunLight = new DirectionalLight("", new Vector3(-1, -1, -0.5), initData.scene);
