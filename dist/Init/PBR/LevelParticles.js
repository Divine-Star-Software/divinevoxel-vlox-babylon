...
export class LevelParticles {
    ...
    static init(scene) {
        ...
        const texture = new Texture("assets/particle.png", scene, false, false, Texture.NEAREST_SAMPLINGMODE, () => {
    ...
    static _getParticleSystem() {
        ...
        if (GPUParticleSystem.IsSupported) {
            particleSystem = new GPUParticleSystem("particles", { capacity: 4_000, randomTextureSize: 4096 }, scene);
        }
        else {
    ...
    static start(color1, color2 = color1, colorDead = color1) {
