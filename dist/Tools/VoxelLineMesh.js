...
export class VoxelLineMesh extends Mesh {
    ...
    constructor(scene, name = "") {
        ...
        this._material = VoxelLineMesh.Materials.get(scene).clone(`Voxel Line Mesh ${name}`);
    ...
    addLineSegment(start, end, normal, thickness) {
        ...
        let norm = Math.sqrt(perpendicular[0] * perpendicular[0] +
        ...
        positions.push(
        //v0
        start[0] + tx, start[1] + ty, start[2] + tz, 
        //v1
        start[0], start[1], start[2], 
        //v2
        end[0] + tx, end[1] + ty, end[2] + tz, 
        //v3
        end[0], end[1], end[2]);
